# EX1 To create a web Portfolio/CV using HTML & CSS
    ...
    <header class="container header active" id="home">
        <div class="header-content">
            <div class="left-header">
                ...
                <div class="image">
                    <img src="D:\Java\assesment3\1.jpg" alt="">
                </div>
            </div>
            <div class="right-header">
                <h1 class="name">
                    Hi, I'm <span>BARATH KUMAR.</span>
                    A Web Developer.
                </h1>
                <p>
...
## RESULT:
Thus the html & css code to create web portfolio/cv has been created and output has been verified.